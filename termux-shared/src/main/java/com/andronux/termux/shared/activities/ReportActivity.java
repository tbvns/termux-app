package com.andronux.termux.shared.activities;
...
import com.andronux.termux.shared.file.filesystem.FileType;
 ...
 * {@code `<activity android:name="com.andronux.termux.shared.activities.shared.ReportActivity" android:theme="@style/Theme.AppCompat.TermuxReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.andronux.termux.shared.activities.shared.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
