package com.andronux.termux.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.andronux.termux.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.andronux.termux/10xxx}
             */
